...
class Operand
{
    public:
        ...
        */
        ...
        /* Multiplication */
        Instruction operator*(Operand op);
        Instruction mult_u(Operand op);
        Instruction operator*(unsigned short value);

        /* Assignment */
        void operator=(Operand op);

        /* We have signed short (i16) immediate operands,
        ...
        static Instruction bitreverse(Operand op); // experimental

        static void reduce(Operand op);
        static void reduce_u(Operand op);
        static void scan(Operand op);
    private:
