...
cnxvector::cnxvector(UINT_INSTRUCTION MainVal, UINT_INSTRUCTION intermediate_val, UINT16 imm_val, UINT_INSTRUCTION op_code)
{
    mval = MainVal;
    ival = intermediate_val;
    imval = imm_val;
...
void cnxvector::operator=(cnxvector other)
{
    ...
    else if (other.mval == LOCALSTORE_MARKER) //read from local sstore. "other" is cnxvector_localstore[cnxvector rX] !
    {
