...
static TestFunction TestFunctionTable[] =
{
    ...
    {NOP_BNR,"IWRITE",InitKernel_Iwrite,{0x01,0x02,(NUMBER_OF_MACHINES-1)*NUMBER_OF_MACHINES/2}},
    {NOP_BNR,"IREAD",InitKernel_Iread,{0x01,0x02,(NUMBER_OF_MACHINES-1)*NUMBER_OF_MACHINES/2}},
    /*
    ...
    */
    ...
    {NOP_BNR,"ADD",InitKernel_Add,{0xff,0xf1,(0xff + 0xf1)*NUMBER_OF_MACHINES}},
    /*
    ...
    */
    {NOP_BNR,"MULTLO",InitKernel_Multlo,{0x2,0x3,(0x2UL * 0x3UL)*NUMBER_OF_MACHINES}},
    /*
    ...
    */
	{NOP_BNR,"CELLSHL",InitKernel_Cellshl,{2,5,5-2}},
	/*
...
int icc_test_Simple_All(ConnexMachine *connex, bool stress)
{
    ...
    for (i = 0; i < sizeof (TestFunctionTable) / sizeof (TestFunction); i++)
    {
        ...
        cout<<"================================"<<endl;
    if (testFails ==0)
        cout<< "== All icc SimpleTests RAN ======" <<endl;
    else
