...
public class AsmCodePanel extends CodePanel{
    ...
    public AsmCodePanel(AssemblerGui _parentFrame) {
        super(_parentFrame);
        extension = ".asm";
        initFileChooser();
    }

    public AsmCodePanel(AssemblerGui _parentFrame, String _fileName) throws IOException{
        super(_parentFrame, _fileName, true);
        extension = ".asm";
        updateHighlight();
    }
