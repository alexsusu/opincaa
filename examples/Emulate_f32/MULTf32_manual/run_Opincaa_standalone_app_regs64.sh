...
#OPINCAA_HOME=~/Connex/opincaalib
...
# Usage: ./simulator CVL CONNEX_MEM_NUM_ROWS CONNEX_REG_COUNT INTERNAL_INSTRUCTION_MEMORY_SIZE checkForDataHazards useLaneGatingOnConnex
#     Note: all these parameters should be power of 2
# valgrind $OPINCAA_HOME/simulator/build/simulator 128 1024 32 1024 &
$OPINCAA_HOME/simulator/build/simulator 128 1024 64 1024 &
# Although not really required Give some time to the simulator to create the FIFOs, etc
sleep 1

# Usage: ./a.out CONNEX_VECTOR_LENGTH CONNEX_MEM_NUM_ROWS CONNEX_REG_COUNT INTERNAL_INSTRUCTION_MEMORY_SIZE checkForDataHazards useLaneGatingOnConnex
#     Note: all these parameters should be power of 2
# valgrind ./a.out 128 1024 32 1024
./a.out 128 1024 64 1024
