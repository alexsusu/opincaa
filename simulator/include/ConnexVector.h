...
class ConnexVector {
    public:
        ...
        /*
         * Computes the unsigned reduction of this Vector (with unsigned elements)
         *
         * @return the value of the unsigned reduction operation (with unsigned elements)
         */
        int reduce_u();
         ...
         *
         * @param data the array of ConnexVectorElementType to load
         */
        void write(ConnexVectorElementType *data);

        /*
         * Return the data contained in all cells as a ConnexVectorElementType data
         *
         * @return the array of ConnexVectorElementType taken from each cell
         */
        ConnexVectorElementType *read();
        ...
        void operator=(ConnexVectorElementType value);
        void operator=(bool value);

        void operator*(ConnexVector &anotherVector);
        // Unsigned multiplication
        void mult_u(ConnexVector &anotherVector);
        ...
        static void Unconditioned_Set(ConnexVector &dstVector, ConnexVector &srcVector);
        static void Unconditioned_Set(ConnexVector &dstVector, bool value);

        ConnexVectorElementType getCellValue(int index) {
            return cells[index];
        }
    ...
    public:
        /*
        // IMPORTANT: This is defined as a macro instead of inlined function
        //  since it uses connexStateObj of type ConnexState, which refers to
        //  objects of type ConnexVector which results in:
        //   <<error: invalid use of incomplete type ‘class ConnexState’>>
        inline bool IsCellActive(int index) {
            return (connexStateObj.active.cells[index] == 1) &&
                   (connexStateObj.cellDisabled.cells[index] == 0);
        }
        */

        /*inline*/ int SelectOnCellActive(int index, int valT, int valF);
        void Print();

        /*inline*/ int getNumberActiveLanes();
...
class ConnexState {
    public:
      // Actual state vectors:
        ...
        /*
         * The cell flag to support lane gating
         */
        ConnexVector cellDisabled;
