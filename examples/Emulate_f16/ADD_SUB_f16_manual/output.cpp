...
//
    // Testing that doing SHR for 16+ positions is done in "two parts" to work on Connex
    opA[0] = 0xc4c9; // F16 encoding for (S=1,E=0x11,F=0x4c9)
    opB[0] = 0x079a; // F16 encoding for (S=0,E=0x1,F=0x79a)
    resCorrect[0] = 0xc4c9; // as obtained in ARM __fp16 (S=1,E=0x11,F=0x4c9)
...
//
        ...
        opA[0] = 0x7BFF; // F16 encoding for (S=1,E=0x11,F=0x4c9)
        opB[0] = 0x7BFF; // F16 encoding for (S=0,E=0x1,F=0x79a)
        resCorrect[0] = F16_INF_POSITIVE; // as obtained in ARM __fp16 (S=1,E=0x11,F=0x4c9)
