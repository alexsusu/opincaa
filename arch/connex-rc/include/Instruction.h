...
#define GET_OPCODE(x) ((x >> OPCODE_POS) & ((1 << OPCODE_SIZE)-1))
...
#define _ICELL_SHR    0x2C       /* 0b101100 */

#define _CELL_SHL     0x0D       /* 0b001101 */	
#define _ICELL_SHL    0x2D       /* 0b101101 */

#define _WRITE        0x0E       /* 0b001110 */
#define _IWRITE       0x2E       /* 0b101110 */

#define _READ         0x0F       /* 0b001111 */
#define _IREAD        0x2F       /* 0b101111 */

#define _VLOAD        0x10       /* 0b010000 */
#define _IVLOAD       0x30       /* 0b110000 */

#define _EQ           0x11       /* 0b010001 */
#define _IEQ          0x31       /* 0b110001 */

#define _ULT          0x12       /* 0b010010 */
#define _IULT         0x32       /* 0b110010 */

#define _LT           0x13       /* 0b010011 */
#define _ILT          0x33       /* 0b110011 */

#define _SHL          0x14       /* 0b010100 */
#define _ISHL         0x34       /* 0b110100 */

#define _SHR          0x15       /* 0b010101 */
#define _ISHR         0x35       /* 0b110101 */

#define _SHRA         0x16       /* 0b010110 */
#define _ISHRA        0x36       /* 0b110110 */

#define _MULT         0x17       /* 0b010111 */
#define _IMULT        0x37       /* 0b110111 */

#define _ADD          0x18       /* 0b011000 */
#define _IADD         0x38       /* 0b111000 */

#define _SUB          0x19       /* 0b011001 */
#define _ISUB         0x39       /* 0b111001 */

#define _ADDC         0x1A       /* 0b011010 */
#define _IADDC        0x3A       /* 0b111010 */

#define _SUBC         0x1B       /* 0b011011 */
#define _ISUBC        0x3B       /* 0b111011 */

#define _NOT          0x1C       /* 0b011100 */

#define _OR           0x1D       /* 0b011101 */
#define _IOR          0x3D       /* 0b111101 */

#define _AND          0x1E       /* 0b011110 */	
#define _IAND         0x3E       /* 0b111110 */	
