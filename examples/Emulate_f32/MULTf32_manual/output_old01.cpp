...
void FloatMulTest(ConnexMachine *connex) {
    uint32_t opA[CONNEX_VECTOR_LENGTH];
    uint32_t opB[CONNEX_VECTOR_LENGTH];
    uint32_t resCorrect[CONNEX_VECTOR_LENGTH];
    uint32_t result[CONNEX_VECTOR_LENGTH];
    ...
    */
    opA[0] = 0x8c6c7e73; // F32 encoding for non-denormal ...
    opB[0] = 0x2b89f642; // F32 encoding for non-denormal ...
