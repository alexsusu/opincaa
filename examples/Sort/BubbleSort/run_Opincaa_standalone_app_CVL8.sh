# Running on fewer lanes helps to better understand what happens when running
...
# valgrind $OPINCAADIR/simulator/build/simulator 128 1024 32 1024 &
$OPINCAA_HOME/simulator/build/simulator 8 1024 32 1024 &
#$OPINCAADIR/simulator/build/simulator 16 1024 32 1024 &
#$OPINCAADIR/simulator/build/simulator 128 1024 32 1024 &
# Although not really required Give some time to the simulator to create the FIFOs, etc
sleep 1

# valgrind ./a.out 128 1024 32 1024
./a.out 8 1024 32 1024
#./a.out 16 1024 32 1024
