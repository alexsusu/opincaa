...
void Div_f16Kernel(int32_t opAPtr, int32_t opBPtr, int32_t resPtr) {
    ...
    //
    #define SRC1           26
    #define SRC1_MANTISSA_L  25
    #define SRC1_MANTISSA_H  25
    #define SRC1_EXPONENT  24
    #define SRC1_SIGN      23
    //
    #define SRC2           22
    #define SRC2_MANTISSA_L  21
    #define SRC2_MANTISSA_H  21
...
//    #define DST_SIGN       15
   ...
   // Note that these variables are already allocated to other registers
    #define ZERO1           7
    #define ZERO2           6
    #define V2              5
    #define V1             11
